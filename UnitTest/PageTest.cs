...
namespace UnitTest
{
    ...
    public class PageTest
    {
        ...
        public static void CleanupClass()
        {
            ...
            Controller.instance.DeleteProduct(Controller.instance.FindPageByName("Test Supplier").Products.Find(prod => prod.ProductName.Equals("Test Product")));
            Controller.instance.DeleteProduct(Controller.instance.FindPageByName("Test Supplier").Products.Find(prod => prod.ProductName.Equals("New Test Product")));
