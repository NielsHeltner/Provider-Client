...
namespace UnitTestClass.page
{
    ...
    public class PageUnitTest
    {
        ...
        public void SearchTest()
        {
            ...
            var page1 = new Page(new Supplier("DSM Nutritional Products Ltd", "somepswd"));
            ...
            var page2 = new Page(new Supplier("Fenchem Biotek Ltd", "somepswd"));
            ...
            var page3 = new Page(new Supplier("Chr.Olesen Nutrition A/S", "somepswd"));
            ...
            Assert.AreEqual("DSM Nutritional Products Ltd", pm.Search("rovimix")[0].name);
